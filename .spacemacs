...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(html
     ...
     ;; org
     (shell :variables
            terminal-here-terminal-command (list "terminator")
